        ...
        return (
            <Container title={ProfilePageContent.page_title}
                ...
                <View style={styles.mainContent}>
                    <View style={{ flexDirection: 'row', justifyContent: 'space-between',marginTop:this.state.contesttype == 'free_to_play_contest' ?0:'3%' ,height:'8%'}}>
                    ...
                    <View style={{ justifyContent: 'center', alignItems: 'center',height:'5%'}}>{this.state.contesttype == 'free_to_play_contest'?<Text style={styles.Current_Text_Style}>{this.state.responsedata.contest_result=='FINAL'?'FINAL STANDINGS':'CURRENT STANDINGS'}</Text>:<Text style={styles.Current_Text_Style}>CURRENT STANDINGS</Text>}
                    ...
                    {this.state.StandlingList.length > 0 ?
                        <View style={[styles.Flatlist_Style,{backgroundColor:(this.state.contesttype == 'free_to_play_contest')?'#FFF':'#dddddd'}]}>
                            {this.state.contesttype == 'free_to_play_contest'?this.state.responsedata.contest_result=='FINAL'?<View style={{width:'100%',flexDirection:'row',backgroundColor: '#666666',height:'8%'}}>
                            ...
                            </View>:<View style={{width:'100%',flexDirection:'row',backgroundColor: '#666666',height:'8%'}}>
                                ...
                                renderItem={({ item, index }: any) => {
                                    ...
                                    return (
                                       ...
                                       {this.state.responsedata.contest_result=='FINAL'? <View style={{backgroundColor:'white',flexDirection:'row',borderBottomWidth:0.5,borderTopWidth: subindex==0?0.5:0,borderColor:'#dddddd'}}>
                                           ...
                                           <View style={{width:item.type!=''?'63%':'98%',justifyContent:'center'}}>  
                                      ...
                                      {item.type!=''?<View style={{width:'36%',justifyContent:'center'}}>
                                    ...
                                    {/* </TouchableOpacity>  */}
                                        ...
                                        {/* </TouchableOpacity> */}
                                       {/* {this.state.responsedata.contest_result=='FINAL'?item.min_picks_flag=='0' && <View style={{width:'100%',borderTopWidth:1,borderTopColor:'black',position:'absolute',bottom:20}}/>:null} */}
                                        </View>
                                    )
                                }} /></View>:
                                <View style={{width:'100%',height:'92%'}}>
