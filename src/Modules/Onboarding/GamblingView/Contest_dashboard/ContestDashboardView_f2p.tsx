...
class ContestDashboardView extends AppValidationComponent<G_ContestDashboardViewProps, G_ContestDashboardViewState>
  ...
  callMethod(count: any) {
    ...
    AsyncStorage.multiGet(['league_id', 'contest_id', 'private_contest_id', 'from_private_contest','contest_type']).then((data) => {
  ...
  iconDidTapped() {
    if (Application.sharedApplication().user!.profile.userType == 'Guest') {
      ...
      this.props.navigation!.navigate(AppScreens.G_Settings_2_View, { contest: true });
    }
  }
...
this.setState({textlength:e.nativeEvent.text.length})
  ...
  showDialogfree2p(isShow: any, item: any) {
    console.log('showDialogfree2p',item)
    // alert('showDialogfree2p')
    if(this.state.contesttype=='free_to_play_contest'){
      if(this.state.contestdata.bankroll=='N')
      {
        // alert('showDialogfree2p')
  ...
  showDialog(isShow: any, item: any) {
    // this.state.contesttype=='free_to_play_contest'?this.state.contestdata.bankroll=='N'?
    if (this.state.TitleofMoneylineDialog == 'Amount to Win:') {
                ...
                <View style={[styles.dialog_text_input_container, { flexDirection: 'row' }]}>
                  ...
                  <TextInput
                   ...
                   // onKeyPress={(e: any) => { e.nativeEvent.key == "Backspace" ? this.handleBackSpace("BA") : this.handleKeyDown(e, value, "BA", GamesArray.MasterCalcFlag) }}
                    ...
                    placeholder={this.state.contesttype=='free_to_play_contest'?'Enter Bet Bankroll':'Enter Bet Amount'}
                ...
                <View style={[styles.dialog_text_input_container, { flexDirection: 'row' }]}>
                  ...
                  <TextInput
                   ...
                   // onKeyPress={(e: any) => { e.nativeEvent.key == "Backspace" ? this.handleBackSpace("ATW") : this.handleKeyDown(e, value, "ATW", GamesArray.MasterCalcFlag) }}
                    ...
                    placeholder={this.state.contesttype=='free_to_play_contest'?'Enter Bankroll to Win':'Enter Amount to Win'}
        ...
        <View style={styles.scrollContent}>
          ...
          <View style={[styles.mainContent, { width: '100%' }]}>
            ...
            <View style={{ width: '100%', justifyContent: 'center', alignItems: 'center', marginTop: 10 }}>
              ...
              <View style={{  width: this.state.contesttype=='free_to_play_contest'?'85%':'100%', justifyContent: 'center', alignItems: 'center', padding: 5 }}>
                <Text style={{ color: 'black', fontFamily: 'Montserrat-Bold', fontSize: hp(1.7) }}>{this.state.ChallengeName}</Text>
                <Text style={{ color: 'black', fontFamily: 'Montserrat-Medium', fontSize: hp(1.2) }}>{this.state.RegisterDate}-{this.state.EndDate}</Text>
                </View>
               {this.state.contesttype=='free_to_play_contest'? <View style={{width:'15%'}}>
                  <TouchableOpacity onPress={()=>{this.openDetailmodel(this.state.contestid)}} style={{ position: 'absolute',  bottom: '10%' ,width: '100%',marginLeft:5 }}>
            ...
            <Text style={{ color: 'black', fontFamily: 'Montserrat-SemiBold', fontSize: hp(1.7) }}><Text style={{ color: 'black', fontFamily: 'Montserrat-Bold', fontSize: hp(1.9) }}>{'('}</Text>{'Availabel Bankroll Amount: '}<Text style={{ color: 'black', fontFamily: 'Montserrat-Bold', fontSize: hp(1.9) }}>{this.state.contestdata.avaiable_bankroll_amount+')'}</Text></Text>
              </View>:null:null}
                          ...
                          <View style={{ backgroundColor: '#999999' }}>
                            ...
                            <View style={[styles[this.isMainBlockHeight], { width: '100%', alignItems: 'center' }]}>
                              ...
                              <View style={styles.flatlist_data_whole_row}>
                                ...
                                {this.state.selected_Legue_id == '9' ? <View style={styles.flatlist_data_4column}>
                                  ...
                                  <View style={[styles.flatlist_data_row_height, styles[this.blockHeight], { borderBottomColor: 'white', borderBottomWidth: 1 }]}>
                                    ...
                                    <TouchableWithoutFeedback onPress={() => {(item.games.MONEY_LINE.home.value == 0 || item.games.MONEY_LINE.home.value == "N/A") ? null :this.state.contesttype=='free_to_play_contest'?this.state.contestdata.bankroll=='N'?this.showDialogfree2p(true, item): this.getDialogueState2(item, index, 'M', ArrayLength):this.getDialogueState2(item, index, 'M', ArrayLength),(item.games.MONEY_LINE.home.value == 0 || item.games.MONEY_LINE.home.value == "N/A") ? null:this.state.contesttype=='free_to_play_contest'?this.state.contestdata.bankroll=='N'?this.getDialogueState2(item, index, 'M', ArrayLength):null:null}}>
                                      <View style={[{
                                    ...
                                    <TouchableWithoutFeedback onPress={() => {(item.games.TOTAL.home.value == 0 || item.games.TOTAL.home.value == "N/A") ? null : this.state.contesttype=='free_to_play_contest'?this.state.contestdata.bankroll=='N'?this.showDialogfree2p(true, item): this.getDialogueState2(item, index, 'T', ArrayLength):this.getDialogueState2(item, index, 'T', ArrayLength),(item.games.TOTAL.home.value == 0 || item.games.TOTAL.home.value == "N/A") ? null :this.state.contesttype=='free_to_play_contest'?this.state.contestdata.bankroll=='N'?this.getDialogueState2(item, index, 'T', ArrayLength):null:null}}>
                                      <View style={[{
                                    ...
                                    <TouchableWithoutFeedback onPress={() => {(item.games.SPREAD.home.value == 0 || item.games.SPREAD.home.value == "N/A") ? null :this.state.contesttype=='free_to_play_contest'?this.state.contestdata.bankroll=='N'?this.showDialogfree2p(true, item): this.getDialogueState2(item, index, 'S', ArrayLength):this.getDialogueState2(item, index, 'S', ArrayLength),(item.games.SPREAD.home.value == 0 || item.games.SPREAD.home.value == "N/A") ? null :this.state.contesttype=='free_to_play_contest'?this.state.contestdata.bankroll=='N'?this.getDialogueState2(item, index, 'S', ArrayLength):null:null}}>
                                      <View style={[{
                                  ...
                                  {(item.odds.ml_draw_price != 0 || item.odds.ml_draw_price != "") && <TouchableWithoutFeedback onPress={() => {(item.odds.ml_draw_price == 0 || item.odds.ml_draw_price == "") ? null : this.state.contesttype=='free_to_play_contest'?this.state.contestdata.bankroll=='N'?this.showDialogfree2p(true, item): this.getDialogueState2(item, index, 'D', ArrayLength):this.getDialogueState2(item, index, 'D', ArrayLength),(item.odds.ml_draw_price == 0 || item.odds.ml_draw_price == "") ? null :this.state.contesttype=='free_to_play_contest'?this.state.contestdata.bankroll=='N'?this.getDialogueState2(item, index, 'D', ArrayLength):null:null}}>
                                    <View style={[{
                                  ...
                                  <View style={[styles.flatlist_data_row_height, styles[this.blockHeight], { borderTopColor: 'white', borderTopWidth: 1, borderBottomColor: 'white', borderBottomWidth: 1 }]}>
                                    ...
                                    <TouchableWithoutFeedback onPress={() => {(item.games.MONEY_LINE.away.value == 0 || item.games.MONEY_LINE.away.value == "N/A") ? null : this.state.contesttype=='free_to_play_contest'?this.state.contestdata.bankroll=='N'?this.showDialogfree2p(true, item): this.getDialogueState(item, index, 'M', ArrayLength):this.getDialogueState(item, index, 'M', ArrayLength),(item.games.MONEY_LINE.away.value == 0 || item.games.MONEY_LINE.away.value == "N/A") ? null :this.state.contesttype=='free_to_play_contest'?this.state.contestdata.bankroll=='N'?this.getDialogueState(item, index, 'M', ArrayLength):null:null}}>
                                      <View style={[{
                                    ...
                                    <TouchableWithoutFeedback onPress={() => {(item.games.TOTAL.away.value == 0 || item.games.TOTAL.away.value == "N/A") ? null : this.state.contesttype=='free_to_play_contest'?this.state.contestdata.bankroll=='N'?this.showDialogfree2p(true, item): this.getDialogueState(item, index, 'T', ArrayLength):this.getDialogueState(item, index, 'T', ArrayLength),(item.games.TOTAL.away.value == 0 || item.games.TOTAL.away.value == "N/A") ? null :this.state.contesttype=='free_to_play_contest'?this.state.contestdata.bankroll=='N'?this.getDialogueState(item, index, 'T', ArrayLength):null:null}}>
                                      <View style={[{
                                    ...
                                    <TouchableWithoutFeedback onPress={() => {(item.games.SPREAD.away.value == 0 || item.games.SPREAD.away.value == "N/A") ? null : this.state.contesttype=='free_to_play_contest'?this.state.contestdata.bankroll=='N'?this.showDialogfree2p(true, item): this.getDialogueState(item, index, 'S', ArrayLength):this.getDialogueState(item, index, 'S', ArrayLength),(item.games.SPREAD.away.value == 0 || item.games.SPREAD.away.value == "N/A") ? null :this.state.contesttype=='free_to_play_contest'?this.state.contestdata.bankroll=='N'?this.getDialogueState(item, index, 'S', ArrayLength):null:null}}>
                                      <View style={[{
                                    ...
                                    <View style={[styles.flatlist_data_row_height, styles[this.blockHeight], { borderTopColor: 'white', borderTopWidth: 1, borderBottomColor: 'white', borderBottomWidth: 1 }]}>
                                      ...
                                      <TouchableWithoutFeedback onPress={() => {(item.games.TOTAL.away.value == 0 || item.games.TOTAL.away.value == "N/A") ? null :this.state.contesttype=='free_to_play_contest'?this.state.contestdata.bankroll=='N'?this.showDialogfree2p(true, item): this.getDialogueState(item, index, 'T', ArrayLength):this.getDialogueState(item, index, 'T', ArrayLength),(item.games.TOTAL.away.value == 0 || item.games.TOTAL.away.value == "N/A") ? null :this.state.contesttype=='free_to_play_contest'?this.state.contestdata.bankroll=='N'?this.getDialogueState(item, index, 'T', ArrayLength):null:null}}>
                                        <View style={[{
                                          ...
                                          {/*  <Text style={[{ color: item.isTotalSelect1 != true ? 'white' : '#68bcbc' }, styles.flatlist_data_text]}>this.showDialog(true, GamesArray)
                                        O {item.games.TOTAL.away.other_value} ({Math.sign(item.games.TOTAL.away.value) == +1 ? '+' : ''}{item.games.TOTAL.away.value})
                                      </Text> */}
                                          <View style={[styles.flatlist_icon_style]} >
                                            {item.games.TOTAL.away.flag && <Icon name="check" size={12} color="white" />}
                            ...
                            {
                            item.isMoneyLineSelect1 == true ?this.state.contesttype=='free_to_play_contest'?this.state.contestdata.bankroll=='N'?null: this.getDialogue(item, index, item.games.MONEY_LINE.away.value, item.games.MATCH_UPS.away.title,item.games.MONEY_LINE.away.private_value):this.getDialogue(item, index, item.games.MONEY_LINE.away.value, item.games.MATCH_UPS.away.title,item.games.MONEY_LINE.away.private_value) : null
                          }
                          {
                            item.isMoneyLineSelect2 == true ?this.state.contesttype=='free_to_play_contest'?this.state.contestdata.bankroll=='N'?null: this.getDialogue(item, index, item.games.MONEY_LINE.home.value, item.games.MATCH_UPS.home.title,item.games.MONEY_LINE.home.private_value):this.getDialogue(item, index, item.games.MONEY_LINE.home.value, item.games.MATCH_UPS.home.title,item.games.MONEY_LINE.home.private_value) : null
                          }
                          {
                            item.isTotalSelect1 == true ?this.state.contesttype=='free_to_play_contest'?this.state.contestdata.bankroll=='N'?null: this.getDialogue(item, index, item.games.TOTAL.away.value, item.games.MATCH_UPS.away.title,item.games.TOTAL.away.private_value):this.getDialogue(item, index, item.games.TOTAL.away.value, item.games.MATCH_UPS.away.title,item.games.TOTAL.away.private_value) : null
                          }
                          {
                            item.isTotalSelect2 == true ? this.state.contesttype=='free_to_play_contest'?this.state.contestdata.bankroll=='N'?null:this.getDialogue(item, index, item.games.TOTAL.home.value, item.games.MATCH_UPS.home.title,item.games.TOTAL.home.private_value):this.getDialogue(item, index, item.games.TOTAL.home.value, item.games.MATCH_UPS.home.title,item.games.TOTAL.home.private_value) : null
                          }
                          {
                            item.isSpreadSelect1 == true ?this.state.contesttype=='free_to_play_contest'?this.state.contestdata.bankroll=='N'?null: this.getDialogue(item, index, item.games.SPREAD.away.value, item.games.MATCH_UPS.away.title,item.games.SPREAD.away.private_value):this.getDialogue(item, index, item.games.SPREAD.away.value, item.games.MATCH_UPS.away.title,item.games.SPREAD.away.private_value) : null
                          }
                          {
                            item.isSpreadSelect2 == true ? this.state.contesttype=='free_to_play_contest'?this.state.contestdata.bankroll=='N'?null:this.getDialogue(item, index, item.games.SPREAD.home.value, item.games.MATCH_UPS.home.title,item.games.SPREAD.home.private_value):this.getDialogue(item, index, item.games.SPREAD.home.value, item.games.MATCH_UPS.home.title,item.games.SPREAD.home.private_value) : null
                          }
                          {
                            item.isBetaFriendSelect == true ? this.state.contesttype=='free_to_play_contest'?this.state.contestdata.bankroll=='N'?null:this.getBetAFriendDialogue(item, index):this.getBetAFriendDialogue(item, index) : null
                          }
                            {
                              item.isMoneyLineDraw == true ? this.state.contesttype=='free_to_play_contest'?this.state.contestdata.bankroll=='N'?null:this.getDialogue(item, index, item.odds.ml_draw_price, item.games.MATCH_UPS.home.title, item.odds.ml_draw_price):this.getDialogue(item, index, item.odds.ml_draw_price, item.games.MATCH_UPS.home.title, item.odds.ml_draw_price) : null
                            }
                          </View>
