...
import { Linking, View, Text, FlatList, TextInput, Platform, Alert, TouchableOpacity, ScrollView, AsyncStorage, Animated, UIManager, TouchableWithoutFeedback, AppState, Share, BackHandler, Keyboard, Dimensions, KeyboardAvoidingView } from "react-native";
 ...
 {/* -------------------------------- Bet Placed user Status check Dialogue --------------------------------*/}
        ...
        <View style={styles.scrollContent}>
          ...
          <View style={[styles.mainContent, { width: '100%' }]}>
           ...
           <View style={{  position: 'absolute',  justifyContent: 'flex-end', bottom: '12%', marginLeft: '3%' }}>
              <MovableView  onDragStart={() =>console.log('drag start')} onDragEnd={() =>console.log('drag end')}>
            <View >
