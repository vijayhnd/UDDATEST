...
class DashboardView extends AppValidationComponent<G_DashboardViewProps, G_DashboardViewState>
    ...
    this.props.dispatch!(serviceAction.request(ServiceType.Bets,
      ...
      responseParser))
       ...
       var customBetRequset = new CustomBetAFriendRequest(
         ...
         this.state.customBetOdds,
         'selected', //'odd type  selected/custom (when create custom props)'
        bet_type,
         bet_amount,
         amount_to_win,
         '2020-04-30 17:30:22', //bet_expired_on
         ''
    )
    var serviceAction = new ServiceAction()
  ...
  async shareOption(item: any, selectedDatavalues: any, bettype: any) {
    ...
    if (bettype == 'ODDS') {
      ...
      url = await this.referralservice.getReferralUrl(url, this.state.ReferString, "U"); // Getting Dynamic Share Link From Firebase
      referStr = "\n Use Referral Code " + this.state.ReferString + " to sign up.";
      MessageString = "I just bet a " + this.state.POSTBetAmount + " UDDA Bucks that  " +this.state.customBetTest + "  and My answer is  "+this.state.customBetQTest1 +" . Would you like to accept the Bet? "
      MessageString += referStr;

      ShowString = <Text style={{ fontFamily: 'Montserrat-Regular', fontSize: hp(1.4), }}>
        I just bet a <Text style={{ fontFamily: 'Montserrat-SemiBold' }}>{this.state.POSTBetAmount}  </Text>
        <Text> UDDA Bucks that </Text>
                  ...
                  <View style={{ backgroundColor: 'white', borderColor: '#cfcfcf', borderWidth: 1, borderRadius: 3, margin: 3 }}>
                    <View style={{ flexDirection: 'row', width: '100%', }}>
                      <View style={{ width: '100%', }}>
                        ...
                        <TextInput
                          ...
                          style={{ borderColor: '#cfcfcf', borderWidth: 1, borderRadius: 3, margin: 3, padding: 8, fontFamily: 'Montserrat-Semibold', fontSize: hp(1.2), }}
                    ...
                    <View style={{ width: '100%', flexDirection: 'column' }}>
                      ...
                      <View style={{ flexDirection: 'row', width: '100%', margin: 3 }}>
                        ...
                        <View style={{ width: '48%' }}>
                          <Text style={{  paddingLeft: 3, paddingBottom: 0, paddingTop:8,width: '100%', fontFamily: 'Montserrat-Semibold', fontSize: hp(1.0) }}> Odds </Text>
                          <View style={{ flexDirection: 'row', width: '100%', borderColor: '#cfcfcf', borderWidth: 1, borderRadius: 3, margin: 3 }}>
                            <Text style={{ paddingLeft: 3,fontFamily: 'Montserrat-Semibold', fontSize: hp(1.1), width: '65%',  backgroundColor: '#eeeeee' }}>ODDS</Text>
                            <Dropdown
                              containerStyle={{ paddingLeft: 8, borderBottomWidth: 0, justifyContent: "center", width: '35%', backgroundColor: '#eeeeee' }}
                              dropdownOffset={{ top: 0, left: 0 }}
                              dropdownMargins={{ min: 0, max: 0 }}
                              itemTextStyle={{ paddingLeft: 8, fontFamily: 'Montserrat-Bold', textAlign: 'center', fontSize: hp(1.2), color: '#333333', margin: 0, paddingBottom: 0, width: '100%' }}
                              data={data2}
                              onChangeText={(text) => { this.setState({ customBetOdds: text }) }}
                              fontSize={hp(1.2)}
                              value={''}
                            />
                          </View>
                        </View>
                        <View style={{ width: '48%', marginLeft: 9 }}>
                          <Text style={{ padding: 8, paddingBottom: 0, paddingLeft: 3, width: '100%', fontFamily: 'Montserrat-Semibold', fontSize: hp(1.1) }}> Custom odd </Text>
                          <TextInput
                            value={this.state.customBetCutmOdds}
                            style={{ borderColor: '#cfcfcf', borderWidth: 1, borderRadius: 3, margin: 3, padding: 8, fontFamily: 'Montserrat-Semibold', fontSize: hp(1.2), borderBottomColor: '#cfcfcf', borderBottomWidth: 1 }}
                        ...
                        <View style={{ width: '50%'}}>
                        <Text style={{ paddingTop: 8, paddingBottom: 0, paddingLeft: 3, width: '100%', fontFamily: 'Montserrat-Semibold', fontSize: hp(1.1) }}> Notification to close the bet </Text>


                        <View style={[styles.Input_Container, { flexDirection: 'row', }]}>

                        <View style={{ width: '80%'  }}>
                        <Text style={{ borderColor: '#cfcfcf', borderWidth: 1, borderRadius: 3, margin: 3,marginTop:0,color: 'black', fontFamily: 'Montserrat-SemiBold', padding: 8 }}>{this.state.customBetDate?this.state.customBetDate:'Select Date'}</Text>
                        </View>
                        ...
                        <View style={{ width: '80%' }}>
                        <Text style={{ borderColor: '#cfcfcf', borderWidth: 1, borderRadius: 3, margin: 3,marginTop:0, color: 'black', fontFamily: 'Montserrat-SemiBold', padding: 8 }}>{this.state.customBetTime?this.state.customBetTime:'Select Time'}</Text>
                        </View>
                        <View style={{ width: '10%',marginRight:40, justifyContent: 'center', alignItems: 'flex-end' }}>
                ...
                {this.state.SelectedBetOption != 'C' ?
                  ...
                  <View style={{ marginLeft: 5, marginRight: 5, marginTop: 5, marginBottom: 2 }}>
                    <TouchableOpacity onPress={() => { this.showcustomDialog(true)  }}>
                      <View style={{ backgroundColor: '#dddddd', borderColor: '#cccccc', borderWidth: 2, borderRadius: 5 }}>
                        <Text style={{ padding: 8, fontFamily: 'Montserrat-Bold', fontSize: hp(1.4), color: '#68bcbc' }}>See full list of custom bets.</Text>
                      </View>
                    </TouchableOpacity>
                  </View>
                }
  ...
  <Dialog
         visible={this.state.iscustomdialog}
          ...
          <View style={styles.DialogMain}>
            ...
            {this.state.SelectedBetOption != 'C'?
              ...
              <Text style={styles.DialogHeaderText}> PROP BETS </Text>
              :<Text style={styles.DialogHeaderText}> CUSTOM PROP BETS RESULT </Text>}
       ...
       paddingLeft: wp(3),paddingTop:3}}>
           ...
           <RadioForm
             ...
             <TouchableOpacity style={[styles.circle]} onPress={() => {this.setresult1(item) } } >
             <View style={[this.state.result==item.my_answer?styles.checkedCircle:styles.uncheckedCircle]} />
             </TouchableOpacity>
             <Text style={{paddingLeft:5,fontSize:12,color:'black'}}>{this.state.result}</Text>
             </View>
             <View style={{flexDirection:'row',justifyContent:'space-evenly',paddingLeft:wp(4)}}>
             <TouchableOpacity style={[styles.circle]} onPress={() => {this.setresult2(item)} } >
             <View style={[this.state.result==item.other_answer?styles.checkedCircle:styles.uncheckedCircle]} />
             </TouchableOpacity>
             <Text style={{paddingLeft:5,fontSize:12,color:'black'}}>{item.other_answer}</Text>
             </View>
             <View style={{flexDirection:'row',justifyContent:'space-evenly'}}>
                   ...
                   {(item.custom_props.custom_prop_state == 'FINAL') ?
                     <View style={{ alignItems: 'center',  justifyContent: 'center', alignContent: 'center' }}>
                       <Text style={{
                         ...
                         fontSize: 13,
                         padding: 3
                       }} >Result Declared <Text style={{ fontFamily: 'Montserrat-SemiBold' }} >{item.custom_props.result} </Text> on {moment(item.custom_props.updated_at).format('L LT')}</Text>
                     </View> 
           :<TouchableOpacity style={{width:150,height:18}} onPress={() => { this.publishCustomBet(item) }} >  
