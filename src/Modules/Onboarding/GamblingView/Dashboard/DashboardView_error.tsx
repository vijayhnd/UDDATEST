...
import { Linking, View, Text, FlatList, TextInput, Platform, Alert, TouchableOpacity, ScrollView, AsyncStorage, Animated, UIManager,TouchableHighlight, TouchableWithoutFeedback, AppState, Share, BackHandler, Keyboard, Dimensions, KeyboardAvoidingView,ImageBackground,Modal } from "react-native";
...
{UrlService.OVERLAY==0?<Modal visible={this.state.imagezoom} transparent={true}>
         ...
         <ImageBackground source={require('../../../../images/dash_overlay1.png')}
                                ...
                                <Text 
                                  style={{marginTop:15,fontFamily: 'Montserrat-Bold', fontSize: hp(2.0), textDecorationLine:  'underline',color:'#68bcbc'}}
                                   ...
                                   <TouchableWithoutFeedback  onPress={()=>{this.saveoverlaycurrent()}}>
                                  ...
                                  <TouchableWithoutFeedback onPress={() => (item.games.TOTAL.away.value == 0 || item.games.TOTAL.away.value == "N/A") ? null : this.getDialogueState(item, index, 'T', ArrayLength)}>
                                    <View style={[{
                                      ...
                                      <View style={[styles.flatlist_odd_style]} >
                                        ...
                                        <Text style={[{ color: item.games.TOTAL.away.value == "N/A" ? '#FFFFFF' : item.games.TOTAL.away.result == "L" ? '#666666' : item.isTotalSelect1 != true ? 'white' : '#68bcbc' },styles[this.isfontSize], styles.flatlist_data_text]}>
                                ...
                                <View style={[styles.flatlist_data_row_height, styles[this.blockHeight],{ borderBottomColor: 'white', borderBottomWidth: 1 }]}>
                                  ...
                                  <TouchableWithoutFeedback onPress={() => (item.games.TOTAL.home.value == 0 || item.games.TOTAL.home.value == "N/A") ? null : this.getDialogueState2(item, index, 'T', ArrayLength)}>
                                    <View style={[{
                                      ...
                                      <View style={[styles.flatlist_odd_style]} >
                                        <Text style={[{ color: item.games.TOTAL.home.value == "N/A" ? '#FFFFFF' : item.games.TOTAL.home.result == "L" ? '#666666' : item.isTotalSelect2 != true ? 'white' : '#68bcbc' },styles[this.isfontSize], styles.flatlist_data_text]}>
