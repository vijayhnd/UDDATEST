                  ...
                  <View style={{ backgroundColor: 'white', borderColor: '#cfcfcf', borderWidth: 1, borderRadius: 3, margin: 3 }}>
                    ...
                    <View style={{ width: '100%', flexDirection: 'column' }}>
                      ...
                      <View style={{ flexDirection: 'row', width: '100%', margin: 3 }}>
                        ...
                        <View style={{ width: '48%' }}>
                          <Text style={{ padding: 8, paddingLeft: 3, paddingBottom: 0, width: '100%', fontFamily: 'Montserrat-Semibold', fontSize: hp(1.0) }}> odds </Text>
                          <View style={{ flexDirection: 'row', width: '100%', borderColor: '#cfcfcf', borderWidth: 1, borderRadius: 3, margin: 3 }}>
                            <Text style={{ padding: 8, fontFamily: 'Montserrat-Semibold', fontSize: hp(1.3), width: '65%', paddingTop: 12, backgroundColor: '#eeeeee' }}>ODDS</Text>
                            <Dropdown
                              containerStyle={{ paddingLeft: 8, padding: 8, borderBottomWidth: 0, justifyContent: "center", width: '35%', backgroundColor: '#eeeeee' }}
                              dropdownOffset={{ top: 0, left: 0 }}
                              dropdownMargins={{ min: 0, max: 0 }}
                              itemTextStyle={{ paddingLeft: 8, fontFamily: 'Montserrat-Bold', textAlign: 'center', fontSize: hp(1.2), color: '#333333', margin: 0, paddingBottom: 0, width: '100%' }}
                              data={data2}
                        ...
                        <View style={{ width: '50%'}}>
                        <Text style={{ padding: 8, paddingBottom: 0, paddingLeft: 3, width: '100%', fontFamily: 'Montserrat-Semibold', fontSize: hp(1.1) }}> Notification Expiry Date </Text>


                        <View style={[styles.Input_Container, { flexDirection: 'row', }]}>

                        <View style={{ width: '80%'  }}>
                        <Text style={{ borderColor: '#cfcfcf', borderWidth: 1, borderRadius: 3, margin: 3,color: 'black', fontFamily: 'Montserrat-SemiBold', padding: 10 }}>{this.state.customBetDate}</Text>
                        </View>
                        ...
                        <View style={{ width: '80%' }}>
                        <Text style={{ borderColor: '#cfcfcf', borderWidth: 1, borderRadius: 3, margin: 3, color: 'black', fontFamily: 'Montserrat-SemiBold', padding: 10 }}>{this.state.customBetTime}</Text>
                        </View>
                        <View style={{ width: '20%', justifyContent: 'center', alignItems: 'flex-end' }}>
