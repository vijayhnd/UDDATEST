    ...
    if (bettype == 'ODDS') {
     ...
     var newWinAmount = '"'+this.state.POSTWinAmount.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",")+'"'
      ...
      if (selectedData.MasterCalcFlag == 'D') {
        MessageString = "I am betting on " + newLine + " under " + newoddsString + " for " + newteamName + " Vs " + newteamName2+" . I’ll put up " + newWinAmount + " UDDA bucks to your " + newAmount + " Udda bucks, you can accept all of or any part of my bet.";
...
ShowString = <Text style={{ fontFamily: 'Montserrat-Regular', fontSize: hp(1.4), }}>
  ...
  {referStr}</Text>
      ...
      if (selectedData.MasterCalcFlag == 'D') {
        ShowString = <Text style={{ fontFamily: 'Montserrat-Regular', fontSize: hp(1.4), }}>
          I am betting on <Text style={{ fontFamily: 'Montserrat-SemiBold' }}>{drawOdds} </Text>
        under 
