    ...
    if (bettype == 'ODDS') {
     ...
     var newWinAmount = '"'+this.state.POSTWinAmount.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",")+'"'
      ...
      if (selectedData.MasterCalcFlag == 'D') {
        MessageString = "I am betting on Draw " + newLine + " under " + newoddsString + " for " + newteamName + " Vs " + newteamName2+" . I’ll put up " + newWinAmount + " UDDA bucks to your " + newAmount + " Udda bucks, you can accept all of or any part of my bet.";
