    ...
    async shareOption(item: any) {
        ...
        // @vijay code 
            ...
            var newLine = (item.ml_draw_price) ? '"' + amount + '"' : '"' + item.bet_odds_value + '"'
                 ...
                 MessageString = "I’ll bet you " +  newteamName +" beats  "+ newteamName2 +". The "+teamName+" are "+newLine+ " on the "+newoddsString+". I’ll put up" + newAmount + "UDDA bucks to your "+newWinAmount+" UDDA bucks, you can accept "+ (item.amount >= 2000 ?"all of or any part of my bet ":"")+"or decline by tapping the link below."+ referStr + "\n" + url;;
            if(item.ml_draw_price) {
                MessageString = "I am betting on Draw " + newLine + " under " + newoddsString + " for " + newteamName2 + " Vs " + newteamName + " . I’ll put up " + newAmount + " UDDA bucks to your " + newWinAmount + " UDDA bucks, you can accept "+ (item.amount >= 2000 ?"all of or any part of my bet ":"")+"or decline by tapping the link below.";
...
<Modal visible={this.state.imagezoomqr} transparent={false}>
          ...
          <View style={{backgroundColor:'white',height:'auto'}}>
            ...
            <Text style={styles.DialogHeaderText}> SETTLE CUSTOM BET </Text>
                ...
                {this.state.customData.qr_code&&<View style={{justifyContent:'center',alignContent:'center',alignItems:'center'}}>
                <TouchableOpacity onPress={()=>{this.openQrModel(this.state.customData.qr_code)}}>
                <Image
