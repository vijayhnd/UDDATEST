...
class G_ShareBingoView
  ...
  async shareOption(item: any, bettype: any) {
    ...
    if (bettype == "bingo") {
      url = "http://bet.udda.com/index.php?t=bingo&i=" + item.bingo_id;
        ...
        <View style={{ flex: 1 }}>
          ...
          >
            {this.state.bingodata.map((item, i) => {
              ...
              // b=require("../../../../images/gifts_bg/bingo.png");
              ...
              return (
                <View style={[styles.squareBox]}>
                  <ImageBackground
                    source={
                      i == 12
                        ?this.props.navigation.state.params.bingo_data.bingo_type_id=='1'? require("../../../../images/gifts_bg/bingo.png"):require("../../../../images/Football_center.jpeg")
                        : null
                    }
                    resizeMode="stretch"
                  ...
                  >
                    ...
                    >
                      <View>
                        <Text style={{ color:this.props.navigation.state.params.bingo_data.bingo_type_id=='1'? c:'', textAlign: "center" }}>
                          {i == 12 ? "" : item.gift_name}
                        </Text>
                      </View>
                    </TouchableOpacity>
