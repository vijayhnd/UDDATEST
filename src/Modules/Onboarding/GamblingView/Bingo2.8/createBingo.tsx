...
if(item.coming_soon == '0'){
  ...
  AddCustomGift() {
    if (this.state.customGiftTitle.trim() != "") {
      ...
      AlertUtil.show("Please enter gift title !");
    }
  }
  // ----------------------------------------------- Api calling ---------------------------------------
              ...
              >
                ...
                ></Image>
                  ...
                  >
                    ...
                    >
                      <View style={{ flexDirection: "row" }}>
                        <Icon name="gift" size={25} color="#68bcbc" />
                        <Text
                          style={[
                ...
                >
                  ...
                  >
                    <View style={{}}>
                      ...
                      <View style={{ flexDirection: "row" }}>
                        <Icon name="gift" size={22} color="black" />
                        <Text
                          style={[
                            styles.createsquaaretext,
                            {
                    ...
                    <View style={[styles.ThirdContainer]}>
                      ...
                      >
                        <View style={{ width: "35%" }}>
                          ...
                          >
                            {this.state.selectedgift.length + " Gifts Selected"}
                          </Text>
                        </View>
