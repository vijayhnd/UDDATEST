...
||this.state.prize_type == '' || line_permit.length ==0 || this.state.Post_date_register == '' )
{
...
// return;
    ...
    fetch(UrlService.CONSTURI + 'index.php/' + UrlService.APIVERSION3 + '/PrivateContest/getSeasonEndDate', {
        ...
        .then((responseJson) => {
         ...
         that.setState({ loader: false });  
         this.End_formated_time =    responseJson.data           
                    }
...
change_season(){
    ...
    {
AlertUtil.show('Please Select League !')
    }else{
        if(this.state.End_of_season)
        {
            this.setState({End_of_season:false})
        }else{
            this.setState({End_of_season:true})
                  ...
                  <TouchableHighlight
                    ...
                    onPress={() => {
                      if (this.state.selectedItems.length > 0) {
                        ...
                        AlertUtil.show("Please select minimum 1 League");
                      }
                    }}
                    underlayColor="#fff"
                  >
...
<ProgressLoader
                                ...
                                <View style={styles.ThirdContainer}>
                                    ...
                                    <View style={styles.ThirdContainer}>
                                        ...
                                        <View style={{ width: '100%', justifyContent: 'center', alignItems: 'flex-start',padding:5 }}>
                                                        ...
                                                        <Text>{this.state.selectedItems.length == 0 ?'Select League(s)':this.state.selectedItems.length + ' League(s) Selected'}</Text>
        ...
        /> */}
                                    ...
                                    <View style={styles.ThirdContainer}>
                                        <Text style={styles.Text_Style}>Maximum Number of User</Text>
                                        <View style={styles.Input_Container}>
                                            <TextInput
                                    ...
                                    <View style={styles.ThirdContainer}>
                                        <Text style={styles.Text_Style}>No. of Picks per period</Text>
                                        <View style={[styles.Input_Container, { alignContent: 'center', padding: 5 }]}>
                                            <Dropdown
...
<View style={[styles.ThirdContainer, { width: '49%', marginRight: '1%' }]}>
    <Text style={[styles.Text_Style ]}>End of season</Text>
    <View style={[styles.Input_Container, { flexDirection: 'row',backgroundColor:''}]}>
        <TouchableOpacity onPress={()=>{this.change_season()}}>
        <Image source={ this.state.End_of_season? require('../../../../images/toggle_on_G.png'):require('../../../../images/toggle-off-button.png')}
...
{/* <View style={[styles.Input_Container, { flexDirection: 'row',backgroundColor:'',justifyContent:'center',alignContent:'center',alignItems:'center' }]}> */}
        {/* <TouchableOpacity onPress={()=>{this.change_season()}}>
        <Image source={ this.state.End_of_season? require('../../../../images/toggle_on_G.png'):require('../../../../images/toggle-off-button.png')}
        style={{ height: 40, width: 60 }}
        resizeMode="contain"></Image>
    ...
    {/* </View> */}
                                    ...
                                    <View style={{ flexDirection: 'row', width: '90%' }}>
                                        ...
                                        <View style={[styles.ThirdContainer, { width: '49%', marginRight: '1%' }]}>
                                            <Text style={styles.Text_Style}>First Game Date</Text>
                                            <View style={[styles.Input_Container, { flexDirection: 'row', }]}>
                                        ...
                                        <View style={[styles.ThirdContainer, { width: '49%', marginLeft: '1%' }]}>
                                            <Text style={styles.Text_Style}>Last Game Date</Text>
                                            <View style={[styles.Input_Container, { flexDirection: 'row', }]}>
                                                ...
                                                <View style={{ width: '20%', justifyContent: 'center', alignItems: 'flex-end' }}>
                                                    <TouchableOpacity onPress={this.state.End_of_season?this.End_formated_time?null: this.showDateTimeEndPicker:this.showDateTimeEndPicker}>
                                                        <Image source={require('../../../../images/calendar.png')}
                                                            style={{ height: 20, width: 20, marginRight: 10 }}
                                                            resizeMode="contain" />
                                                    </TouchableOpacity>
                                    ...
                                    <View style={{ flexDirection: 'row', width: '90%' }}>
                                    <View style={[styles.ThirdContainer, { width: '49%', marginLeft: '1%' }]}>
                                            <Text style={styles.Text_Style}>First Date to Register</Text>
                                            <TouchableOpacity onPress={this.showPostDateTimeEndPicker}>
                                            <View style={[styles.Input_Container, { flexDirection: 'row', }]}>

                                                <View style={{ width: '80%' }}>
                                                    <Text style={{ color: 'black', fontFamily: 'Montserrat-SemiBold', padding: 10 }}>{this.state.Post_date_register}</Text>
                                                </View>
                                                <View style={{ width: '20%', justifyContent: 'center', alignItems: 'flex-end' }}>
                                                    <TouchableOpacity onPress={this.showPostDateTimeEndPicker}>
                                                        <Image source={require('../../../../images/calendar.png')}
                                    ...
                                    <View style={[styles.ThirdContainer, { width: '49%', marginLeft: '1%' }]}>
                                            <Text style={styles.Text_Style}>Last Date to Register</Text>
                                            <View style={[styles.Input_Container, { flexDirection: 'row', }]}>

                                                <View style={{ width: '80%' }}>
                                                    <Text style={{ color: 'black', fontFamily: 'Montserrat-SemiBold', padding: 10 }}>{this.state.Last_date_register}</Text>
                                                </View>
                                                <View style={{ width: '20%', justifyContent: 'center', alignItems: 'flex-end' }}>
                                    ...
                                    <View style={{ flexDirection: 'row', width: '90%' }}>
                                        ...
                                        <View style={[styles.ThirdContainer, { width: '100%', marginLeft: '1%' }]}>
                                        <Text style={styles.Text_Style}>Bankroll</Text>
                                        <View style={[styles.Input_Container, { alignContent: 'center', padding: 5 }]}>
                                            <Dropdown
                                                dropdownOffset={{ top: 0, left: 0 }}
                                                dropdownMargins={{ min: 0, max: 0 }}
                                    ...
                                    <View style={styles.ThirdContainer}>
                                        <Text style={styles.Text_Style}>Winner Declared By</Text>
                                        <View style={[styles.Input_Container, { alignContent: 'center', padding: 5 }]}>
                                            <Dropdown
                                                dropdownOffset={{ top: 0, left: 0 }}
                                                dropdownMargins={{ min: 0, max: 0 }}
                                                dropdownPosition={this.state.Bankroll_value=='No'?-3.2:-2.2}
                                                itemTextStyle={[styles.Input_TextStyle, { padding: 5, fontFamily: 'Montserrat-Bold', fontSize: hp(1.2), color: '#333333', margin: 0, paddingBottom: 0, width: '100%' }]}
                                    ...
                                    <View style={styles.ThirdContainer}>
                                        <Text style={styles.Text_Style}>Bets/Lines Permitted (Choose 1,2 or 3)</Text>
                                        <View style={[styles.Input_Container, { alignContent: 'center', padding: 5,backgroundColor:'' }]}>
                                       <View style={{flexDirection:'row'}}>
                                       {this.state.Bankroll_value=='No'?null: <CheckBox
                                       center
                                       containerStyle={{padding:0,backgroundColor:'',margin:0,marginLeft:0}}
                                       title='Money Line'
                                       ...
                                       uncheckedColor='black'
                                        ...
                                        {/* <Text style={{textAlign:'center',marginTop:5}}>Money Line</Text> */}
                                       </View>
                                       ...
                                       uncheckedColor='black'
                                        />
                                       {/* <CheckBox
                                        value={this.state.Check_box2}
                                        tintColors={{ true: '#68bcbc', false: 'black' }}
                                        onValueChange={()=>{this.setState({Check_box2:!this.state.Check_box2})}}
                                        // style={styles.checkbox}
                                        />
                                        <Text style={{textAlign:'center',marginTop:5}}>Total (Over/Under)</Text> */}
                                       </View>
                                       ...
                                       {/* <CheckBox
                                        value={this.state.Check_box3}
                                        tintColors={{ true: '#68bcbc', false: 'black' }}
                                        onValueChange={()=>{this.setState({Check_box3:!this.state.Check_box3})}}
                                        // style={styles.checkbox}
                                        />
                                        <Text style={{textAlign:'center',marginTop:5}}>Point Spread</Text> */}
                                       </View>

                                        {/* <RadioForm
                                radio_props={[{ label: 'Money Line' + '    ', value: 'Money Line' },{ label: 'Total (Over/Under)' + '    ', value: 'Total (Over/Under)' },{ label: 'Point Spread' + '    ', value: 'Total (Over/Under)' }]}
                                //initial={itemindex}
                                ...
                                buttonWrapStyle={{ marginBottom:10,flexWrap:'wrap'}}
                                labelWrapStyle={{ marginBottom:10,flexWrap:'wrap'}}
                              ...
                              />  */}
                                   ...
                                   {this.state.Bankroll_value=='No'?null: <View style={styles.ThirdContainer}>
                                        <Text style={styles.Text_Style}>Bankroll Amount</Text>
                                        <View style={styles.Input_Container}>
                                            <TextInput
                                   ...
                                   {this.state.Bankroll_value=='No'?null: <View style={styles.ThirdContainer}>
                                        <Text style={styles.Text_Style}>Entire Bankroll Available</Text>
                              ...
                              />                   
                                    ...
                                    {/* <View style={styles.ThirdContainer}>
                                        <Text style={styles.Text_Style}>Entry Fee</Text>
                                        <View style={styles.Input_Container}>
                                            <TextInput
                                                onChangeText={(text) => this.setState({ Entry_fee: text })}
                                                keyboardType={'numeric'}
                                                clearTextOnFocus={true}
                                                returnKeyType='done'
                                                style={styles.Input_TextStyle}
                                    ...
                                    {this.state.Bankroll_value=='No'?null:<View style={{ flexDirection: 'row', width: '90%', justifyContent: 'center', alignItems: 'center' }}>
                                        <View style={[styles.ThirdContainer, { width: '49%', marginRight: '1%' }]}>
                                        ...
                                        <View style={[styles.ThirdContainer, { width: '50%' }]}>
                                            <View style={[styles.ThirdContainer, { width: '100%' }]}>
                                                ...
                                                <View style={[styles.Input_Container,,{backgroundColor:this.state.Entire_bankroll=='yes'?'#f7f8fa':'#fff',flexDirection: 'row', }]}>
                                                    <View style={{ justifyContent: 'center', alignItems: 'center' }}>
                                                        <Image source={require('../../../../images/bucks.png')} style={{ height: 12, width: 12, marginLeft: 3 }} />
                                                    </View>
                                                    <TextInput
                                    ...
                                    <View style={styles.ThirdContainer}>
                                        <Text style={styles.Text_Style}>Winning Type</Text>
                                        <View style={[styles.Input_Container,{backgroundColor:'',alignContent:'center',flexDirection:'row',flexWrap:'wrap'}]}>
                                        <RadioForm
                              ...
                              />                   
                                  ...
                                  {this.state.Wining_type=='Swag'?<View style={styles.ThirdContainer}>
                                        <Text style={styles.Text_Style}>SWAG Product</Text>
                                        <View style={[styles.Input_Container, { alignContent: 'center', padding: 5 }]}>
                                            <Dropdown
                                                dropdownOffset={{ top: 0, left: 0 }}
                                                dropdownMargins={{ min: 0, max: 0 }}
                                    ...
                                    </View>:  <View style={styles.ThirdContainer}>
                                        <Text style={styles.Text_Style}>Guaranteed Winning Amount</Text>
                                        <View style={styles.Input_Container}>
                                            <TextInput
                                    ...
                                    <View style={styles.ThirdContainer}>
                                        <Text style={styles.Text_Style}>Minimum Picks</Text>
                                        <View style={styles.Input_Container}>
                                            <TextInput
                                     ...
                                     <View style={styles.ThirdContainer}>
                                        <Text style={styles.Text_Style}>Maximum Picks</Text>
                                        <View style={styles.Input_Container}>
                                            <TextInput
...
{this.state.Bankroll_value=='No'?null:<View style={{width:'100%',alignContent:'center',justifyContent:'center',alignItems:'center'}}>
                                    <View style={styles.ThirdContainer}>
                                        <Text style={styles.Text_Style}>Allow Re-entry</Text>
                                        <View style={[styles.Input_Container,{backgroundColor:'',alignContent:'center',flexDirection:'row',flexWrap:'wrap'}]}>
                                        <RadioForm
                                radio_props={[{ label: 'Yes' + '    ', value: 'yes' },{ label: 'No' + '    ', value: 'no' }]}
                                //initial={itemindex}
                          ...
                          onPress={(value) => { this.changereentryvalue(value)}}
                              ...
                              />                   
                                    ...
                                    <View style={styles.ThirdContainer}>
                                        <Text style={styles.Text_Style}>Currency Type</Text>
                                        <View style={[styles.Input_Container, { alignContent: 'center', padding: 5 }]}>
                                            <Dropdown
                                                dropdownOffset={{ top: 0, left: 0 }}
                                                dropdownMargins={{ min: 0, max: 0 }}
                                    ...
                                    <View style={styles.ThirdContainer}>
                                        <Text style={styles.Text_Style}>No of Entries</Text>
                                        <View style={[styles.Input_Container,{backgroundColor:this.state.Rentry_value=='no'?'#f7f8fa':'#fff'}]}>
                                        <TextInput
                                    ...
                                    <View style={styles.ThirdContainer}>
                                        <Text style={styles.Text_Style}>Threshold Amount</Text>
                                        <View style={[styles.Input_Container,{backgroundColor:this.state.Rentry_value=='no'?'#f7f8fa':'#fff'}]}>
                                            <TextInput
                                    ...
                                    {this.state.No_of_entry_boxes.map((item,index)=>{
                                        return(
                                            <View style={styles.ThirdContainer}>
                                        <Text style={styles.Text_Style}>{'Re-Entry amount '+ (index+1)}</Text>
                                        <View style={styles.Input_Container}>
                                            <TextInput
                            ...
                            <View style={{ backgroundColor: '#68bcbc', height: '10%', justifyContent: 'center', alignItems: 'center', paddingTop: 20 }}>
                                <View style={{ marginTop: 20, width: '100%', justifyContent: 'center', alignItems: 'center' }}>
                                    ...
                                    onPress={() => { !this.state.create_contest_btn && this.createprivate_contest() }}
                                    >
