...
const G_VerifyOTPViewContent = {
    ...
    resendOtpSuccessText: 'New OTP sent successfully sent',
...
interface G_VerifyForgotOTPViewProps extends AppValidationComponentProps {
    verifyOTPRequestStatus?: ServiceRequestStatus
    response?: VerifyOTPResponse
}

interface G_VerifyForgotOTPViewState {
}
...
class G_VerifyForgotOTPView extends Component<G_VerifyForgotOTPViewProps, G_VerifyForgotOTPViewProps> {

    private otp = '';
    private mobileNumber: string | undefined = '';
    private verifyOTPRequestInProgress = false

    constructor(props: G_VerifyForgotOTPViewProps) {
        super(props);
    ...
    componentWillReceiveProps(nextProps: G_VerifyForgotOTPViewProps){
...
export default connect(mapStateToProps)(G_VerifyForgotOTPView);