   ...
   */
    ...
    if (responseJson.message == "Access Expired.") {
       ...
       if(responseJson.error == 0){
        ...
        // if(responseJson.data.joinning_type == 'paid'){
        // Alert.alert(
        //     'Alert',
        //     responseJson.data.joinning_fees+' UDDA Bucks will be deducted for joining this contest.',
        //     [
        //         { text: 'Continue', 
        //         onPress: () => { 
        //             that.setState({loader:false});
        ...
        //    this.props.navigation!.navigate(AppScreens.G_Spinner, { params: { spinner_data: a,spinner_alldata: responseJson.data } });
        //             console.log('No Thanks Pressed');} 
        //     },
        //         {
        //             text: 'Cancel',
        //             onPress: () => {  that.setState({loader:false}) ; console.log('No Thanks Pressed');},
        //             style: 'cancel',
        //         },
        //     ],
        //     { cancelable: false }
    ...
    //    this.props.navigation!.navigate(AppScreens.G_Spinner, { params: { spinner_data: responseJson.data.udda_bucks } });
