...
import { View, Text, Platform, TouchableWithoutFeedback,AsyncStorage, Image, FlatList ,TouchableOpacity,ImageBackground,Modal} from "react-native";
...
class G_InAPPPurchaseViewIOS extends AppValidationComponent<G_InAPPPurchaseViewIOSProps, G_InAPPPurchaseViewIOSState>
      ...
      async saveoverlay(){
          ...
          async closecurrent(){
            ...
            this.setState({imageoverlay:false})
            try {
              await AsyncStorage.setItem('purchaseuddaoverlaycurrent', 'true');
     ...
     async componentDidMount() {
            ...
            var that = this;
            try {
                  current = await AsyncStorage.getItem('purchaseuddaoverlaycurrent');
