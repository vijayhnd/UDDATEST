...
<TouchableOpacity onPress={()=>{this.setState({private_history_show:true})}}>
                    ...
                    :this.state.freetoplay? <View style={{ height: '75%', width: '95%', marginTop: 20, paddingBottom: 10, }}>
                        ...
                        <TouchableOpacity onPress={()=>{this.setState({callcontestswitch:'J'})}} style={{width:'50%'}}>
                        ...
                        <Text onPress={()=>{this.setState({callcontestswitch:'J'})}} style={[styles.Udda_Text,{color:this.state.callcontestswitch =='J' ?'white':'#abe8e6'}]}>Joined/Live</Text>
                        </View>
                        </TouchableOpacity> 
                        <View style={{justifyContent:'center',alignContent:'center',alignItems:'center',width:'1%'}}/>
                            ...
                            <View style={{ height: '100%' }}>
                                ...
                                <FlatList
                                    ...
                                    renderItem={({ item, index }: any) => {
                                        ...
                                        return (
                                            <View style={{ width: '100%', height: 'auto', marginTop: 5, marginBottom: 5,position:'relative'}}>
                                                <ImageBackground source={item.join_type == 'free_to_play_contest'?require('../../../../images/free-to-play-contest-bg.png'):require('../../../../images/UddaContestsGreen.png')}
                                                    resizeMode="stretch"
                                                    style={{ width: '100%', height: 60 }}>
                                                        {item.is_live && <View style={{position:'absolute',justifyContent:'center',alignContent:'center',alignItems:'center',left:'45%'}}><Text style={[{fontSize: hp(1.5),fontFamily: 'Montserrat-Bold',color:'#f26522',textAlign:'center'}]}>{item.is_live_text}</Text></View>}
