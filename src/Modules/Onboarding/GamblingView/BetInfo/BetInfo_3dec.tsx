...
class G_BetInfo extends AppValidationComponent<G_BetInfoViewProps, G_BetInfoViewState>
    ...
    async componentDidMount() {
        ...
        await this.setState({ contest_id: contest_id, user_id: user_id, result_bet_type:result_bet_type,contest_name:contest_name,RegisterDate:RegisterDate,EndDate:EndDate });
        //0 for public
        //1 for private
