...
export class FooterComponent extends Component<FooterComponentProps, FooterComponentState>{
    ...
    callMethod(league_id: any) {
        ...
        fetch(UrlService.CONSTURI + 'index.php/'+ UrlService.APIVERSION3 +'/apiNew/getUpcomingMatches', {
            method: 'POST',
            headers: {
            ...
            .then((responseJson) => {
                ...
                if (responseJson.highlights.matchups > 0) {
                    this.setState({
                ...
                if (responseJson.current_contest_array.length > 0) {
                    this.setState({
                ...
                console.log("higi", JSON.stringify(this.state.Highlight));
                console.log("most", JSON.stringify(this.state.MostOpen));
                console.log(JSON.stringify(this.state.current_contest_array));
                if (this.state.Highlight.length > 0) {
                    if (typeof this.state.Highlight[0].match_time_stamp !== "undefined") {
                ...
                if (this.state.MostOpen.length > 0) {
                    if (typeof this.state.MostOpen[0].match_time_stamp !== "undefined") {
                ...
                var contest_date ='';
                var contest_name ='';
                if (this.state.current_contest_array.length > 0) {
                    if (typeof this.state.current_contest_array[0].contest_end_date !== "undefined") {
                        contest_date = moment(this.state.current_contest_array[0].contest_end_date).format("Do MMM");
                    }
                    if (typeof this.state.current_contest_array[0].contest_name !== "undefined") {
                        contest_name = this.state.current_contest_array[0].contest_name;
                    }

                }


                this.setState({ ContestTeam1: contest_name});
